...
echo "                    <input name=\"title\" class=\"input-bg\" value=".$course['title'].">\n";
echo "                    <p class=\"pkurz\">Kurzbeschreibung (Wird auf der Startseite angezeigt):</p>\n";
echo "					<textarea name=\"summary\" class=\"txtarea\">".$course['summary']."";
echo "					<p class=\"plernen\">Was kann man in diesem Kurs lernen?</p>\n";
echo "									<textarea name=\"educationalContent\" class=\"txtarea\">".$course['educationalContent']."";
echo "					\n";
echo "					\n";
...
echo "							<input name=\"instructorName\" class=\"input-bg input-1\" value=".$course['instructorName']."/>\n";
echo "							<br>\n";
echo "							<p>Kontaktmöglichkeiten:</p>\n";
echo "							<textarea name=\"instructorContact\" class=\"txtarea\">".$course['instructorContact']."\n";
echo "				</textarea>\n";
echo "\n";
echo "						</div>\n";
echo "						<div class=\"uploaded-img-wrapper column-2\">\n";
echo "							<img class=\"uploaded-img\" alt=\"Platzhalter für das Bild des Erstellers\" src=".$course['instructorImage']."><br>\n";
...
echo "					<input alt=\"Kruze Beschreibung des Kursbildes, für Benutzer mit Screenreadern\" class=\"input-bg\" >\n";
echo "\n";
echo "\n";
echo "				</fieldset>\n";
echo "								</div>\n";
...
echo "                            <img class=\"upload-img\" alt=\"Platzhalter für das Bild des Kurses\" src=".$course['courseImage'].">\n";
echo "                        </div>\n";
...
echo "                        <textarea name=\"materialContent\" class=\"txtarea\"".$course['materialContent']." \n";
echo "						</textarea>\n";
echo "                    </div> \n";
echo "                </div>\n";
echo "            </div>\n";

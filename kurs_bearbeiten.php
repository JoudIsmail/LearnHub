...
echo "							<input name=\"instructorImage\" class=\"input-img\" type=\"file\" onchange=\"loadInstructorImage(event)\">\n";
echo "						</div>\n";
echo "\n";
echo "\n";
...
echo "														<br>\n";
echo "														<input name=\"courseImage\" class=\"input-img\" type=\"file\" onchange=\"loadCourseImage(event)\">\n";
echo "                        </div>\n";
